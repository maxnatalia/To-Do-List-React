...
export const { addTask, toggleHideDone, toggleTaskDone, removeTask, setAllDone, removeAllTasks, fetchExampleTasks, fetchExampleTasksSuccess, fetchExampleTasksError, setTasks } = tasksSlice.actions;
